 ...
 * @author Luis Alfredo
 */
public class PasswordField extends JPanel implements Patron {
    ...
    private JPasswordField txtField;
    ...
    public PasswordField(Dimension dimension, String texto) {
        super();
    ...
    public PasswordField(Dimension dimension, String texto, int restriccion) {
        super();
        this.dimension = dimension;
        this.texto = texto;
        this.aux = texto;
    ...
    private void inicarComponentes() {
        ...
        txtField = new JPasswordField(texto);
        ...
        txtField.setForeground(COLOR_GRIS_CLARO);
